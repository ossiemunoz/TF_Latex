...
\begin{figure}[ht]
  ...
  \input{Figuras/TF_AoN_00.pdf_tex}
...
\begin{figure}[ht]
  \centering
  \def\svgwidth{\textwidth}
  \input{Figuras/TF_AoN_01_01.pdf_tex}
...
\begin{figure}[ht]
  ...
  \input{Figuras/TF_AoN_01_02.pdf_tex}
...
\begin{figure}[ht]
  \centering
  \def\svgwidth{0.90\textwidth}
  \input{Figuras/TF_AoN_01_03.pdf_tex}
...
\begin{center}
  \includegraphics[width=0.75\textwidth]{TF_Heatmap_Risk.pdf}
  \captionof{figure}{Mapa de calor de riesgos según el valor del RPN (rojo indica críticos >40).}
